...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    class App {
      ...
      constructor(container, options: HyperspeedOptions = {}) {
        ...
        } else if (this.options.distortion == null) {
        ...
        this.speedUpTarget = options.speedUp * 0.3; // Start with 30% of max speed for ambient movement
        this.speedUp = options.speedUp * 0.3;
        this.timeOffset = 0;
      ...
      init() {
        console.log('🚀 Hyperspeed init called');
        ...
        console.log('✅ Left car lights initialized', this.leftCarLights.mesh);

        this.leftCarLights.mesh.position.setX(-options.roadWidth / 2 - options.islandWidth / 2);
        this.rightCarLights.init();
        console.log('✅ Right car lights initialized', this.rightCarLights.mesh);
        this.rightCarLights.mesh.position.setX(options.roadWidth / 2 + options.islandWidth / 2);
        this.leftSticks.init();
        console.log('✅ Light sticks initialized', this.leftSticks.mesh);
      ...
      onMouseUp(ev) {
        ...
        this.speedUpTarget = this.options.speedUp * 0.3; // Return to ambient speed
      }
      ...
      render(delta) {
        if (this.composer) {
          ...
          console.warn('⚠️ Composer not initialized');
        }
      }
    ...
    console.log('🎬 Hyperspeed useEffect running');
    console.log('Container ref:', hyperspeed.current);
    ...
    console.log('📦 Effect options:', effectOptions);
    
    if (typeof options.distortion === 'string') {
      console.log('🔄 Converting distortion string:', options.distortion);
